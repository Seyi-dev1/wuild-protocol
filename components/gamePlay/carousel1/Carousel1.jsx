  ...
  return (
    <div className={styles.carousel1} ref={sections}>
      ...
      <div className={styles.sections}>
        ...
        <div className={`${styles.section} ${styles.section1}`} ref={section1}>
            ...
            <div className={styles.footerGroup}>
              <div className={styles.descriptions}>
                <p>
                  ...
                  Protocol. GDC holders will be able to rent items and upgrades
                  in the shop, buy collectibles in the marketplace, create
                  clans, upgrade Avatars, purchase battelepass tickets etc.
                </p>
              </div>
              <div className={styles.button}>
                <button className={spaceGrotesk.className}>Coming Soon</button>
              </div>
            </div>
          </div>
        ...
        <div className={`${styles.section} ${styles.section2}`} ref={section2}>
          <div className={styles.wordings}>
            <div className={styles.headerGroup}>
              <div className={styles.header}>
                <div className={styles.icon}>
            ...
            <div className={styles.footerGroup}>
              <div className={styles.descriptions}>
                <p>
                  ...
                  gameplay itself and decrease the friction generated by Loots.
                  Dust holders will be able to craft items, purchase skill gems
                  and avatar skins. Dusts are not tradeable.
                </p>
              </div>
              <div className={styles.button}>
                <button className={spaceGrotesk.className}>Coming Soon</button>
        ...
        <div className={`${styles.section} ${styles.section3}`} ref={section3}>
          <div className={styles.wordings}>
            <div className={styles.headerGroup}>
              <div className={styles.header}>
                <div className={styles.icon}>
            ...
            <div className={styles.footerGroup}>
              <div className={styles.descriptions}>
                <p>
                  ...
                  Protocol. Guild holders will be able to claim rewards if they
                  stake their tokens, play tournaments, and participate in key
                  governance.
                </p>
              </div>
              <div className={styles.button}>
